...
$targets = @(
    @{ Runtime = "Mono"; Assembly = (Join-Path $MonoGamePath "Schedule I_Data\Managed\FishNet.Runtime.dll"); Type = "FishNet.Managing.Server.ServerManager"; Patterns = @("Transport_OnRemoteConnectionState", "ClientAuthenticated") },
    @{ Runtime = "IL2CPP"; Assembly = (Join-Path $Il2CppGamePath "MelonLoader\Il2CppAssemblies\Il2CppFishNet.Runtime.dll"); Type = "Il2CppFishNet.Managing.Server.ServerManager"; Patterns = @("Transport_OnRemoteConnectionState", "ClientAuthenticated") },
    ...
    @{ Runtime = "Mono"; Assembly = (Join-Path $MonoGamePath "Schedule I_Data\Managed\Assembly-CSharp.dll"); Type = "ScheduleOne.Networking.SteamLobbyService"; Patterns = @("PlayerEnterOrLeave", "m_ulSteamIDUserChanged") },
    @{ Runtime = "IL2CPP"; Assembly = (Join-Path $Il2CppGamePath "MelonLoader\Il2CppAssemblies\Assembly-CSharp.dll"); Type = "Il2CppScheduleOne.Networking.SteamLobbyService"; Patterns = @("PlayerEnterOrLeave", "LobbyChatUpdate_t") }
)
